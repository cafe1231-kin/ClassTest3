...
class mole {
    ...
    spawn(){
        ...
        //第五回目課題を参考にしてみよう
        this.dom_mole.style.visibility = "visible";
    ...
    despawn(){
        ...
        //第五回目課題を参考にしてみよう
        this.dom_mole.style.visibility = "hidden";
 ...
 */
 ...
 const dom_moles = document.getElementsByClassName("moles");
 const molesLength = dom_moles.length;
 const moles = [];

 for(let i =0; i<molesLength; i++){
     moles[i] = mole(dom_moles[i]);
 }

 for(const mole of moles){
     mole.getDOM.addEventLisner('Click', function(){
         mole.defeated();
     });
 }